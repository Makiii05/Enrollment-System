<x-department_sidebar>
    ...
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('department.student') }}" class="btn btn-ghost btn-sm">
    ...
    <form action="{{ route('department.student.update', $student->id) }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('department.student') }}" class="btn btn-ghost">Cancel</a>
