...
<head>
    ...
    <title>{{ strtoupper(env('APP_NAME')) }} - Interview List</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 10mm;
...
<body>
    ...
    <div class="title">INTERVIEW APPLICANTS LIST</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($applicant->interviewSchedule)
                        {{ date('Y-m-d', strtotime($applicant->interviewSchedule->date)) }} | {{ date('g:i A', strtotime($applicant->interviewSchedule->start_time)) }} - {{ date('g:i A', strtotime($applicant->interviewSchedule->end_time)) }}
                    @endif
                </td>
            </tr>
            @empty
